...
CREATE TABLE Store ( storeID integer, 
		             ...
		             PRIMARY KEY(storeID), 
                     FOREIGN KEY(managerID) REFERENCES Users(userID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Orders ( 
                     ...
                     FOREIGN KEY(storeID, productName) REFERENCES Product(storeID, productName) ON DELETE CASCADE ON UPDATE CASCADE
);
